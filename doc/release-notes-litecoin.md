Cypherfunk Core version *0.15.1* is now available from:
  ...
  <https://download.cypherfunk.org/cypherfunk-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 funks per kB (0.00001 FUNK). This is to prepare for dropping the minimum transaction fee to 0.1 funks per kB (0.0001 FUNK) in the next release.
