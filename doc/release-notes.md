Cypherfunk Core version *0.15.1* is now available from:
...
All changes are outlined in the release notes folder located here:

  <https://github.com/The-Cypherfunks/The-Cypherfunkstree/master/doc/release-notes>
  
The previous version of Cypherfunks was based on Bitcoin 0.8.6.2.

Please report bugs using the issue tracker at GitHub:

  <https://github.com/The-Cypherfunks/The-Cypherfunksissues>
...
A number of changes to the way Cypherfunk Core deals with peer connections and invalid blocks
...
- #11433 `e169349` Restore cypherfunk-util-test py2 compatibility (MarcoFalke)
- #11308 `2e1ac70` zapwallettxes: Wait up to 3s for mempool reload (MarcoFalke)
- #10798 `716066d` test cypherfunk-cli (jnewbery)
...
- #11125 `812c870` Add cypherfunk-cli -stdin and -stdinrpcpass functional tests (promag)
- #11077 `1d80d1e` fix timeout issues from TestNode (jnewbery)
- #11078 `f1ced0d` Make p2p-leaktests.py more robust (jnewbery)
- #11210 `f3f7891` Stop test_cypherfunk-qt touching ~/.cypherfunk (MeshCollider)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in cypherfunk-tx [multisig] output adds (TheBlueMatt)
