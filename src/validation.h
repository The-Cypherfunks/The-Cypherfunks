...
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = 25.0 * COIN;
//! Discourage users to set fees higher than this amount (in satoshis) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 25.0 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in satoshis)
static const CAmount HIGH_MAX_TX_FEE = HIGH_TX_FEE_PER_KB;
