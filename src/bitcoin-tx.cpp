...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cypherfunk-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cypherfunk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cypherfunk transaction") + "\n" +
              "  cypherfunk-tx [options] -create [commands]   " + _("Create hex-encoded cypherfunk transaction") + "\n" +
              "\n";
