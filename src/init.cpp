...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/The-Cypherfunks/The-Cypherfunks>";
    const std::string URL_WEBSITE = "<https://cypherfunk.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Cypherfunk version %s\n", FormatFullVersion());
}
